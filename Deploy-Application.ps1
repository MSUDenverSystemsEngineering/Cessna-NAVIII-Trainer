...
Try {
    ...
    [string]$appVendor = 'Garmin'
    [string]$appName = 'NAVIII Trainer'
    [string]$appVersion = '20.05'
    [string]$appArch = 'x64'
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '05/19/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'Garmin Integrated Flight Deck GDU Trainer - MFD, GDU 20.05.S08 GIT:fbe9ac50' -CheckDiskSpace -PersistPrompt
        ...
        $exitCode = Execute-Process -Path "$dirFiles/Cessna NAVIII Trainer v20.05.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'Garmin Integrated Flight Deck GDU Trainer - MFD, GDU 20.05.S08 GIT:fbe9ac50' -CloseAppsCountdown 60
        ...
        $exitCode = Execute-Process -Path "$envHomePath\Cessna NAVIII Trainer v20.05\uninst.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
        If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {$mainExitCode = $exitCode.ExitCode}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEJGgbiK6BAhkb
# jYMfHQhVxSsC/T8RXupxwWZeS3F3hKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAzZRHZrWfuJxJA
# KmVl8fE3SP8x8xBVjB/IhVOzilsSQTANBgkqhkiG9w0BAQEFAASCAYCBQ7/LbRCZ
# J6TCIaNeXbQjdKCwdNA8fRGez4oovH2lAsY0QgqGKHZofjwF4rkFAmSmsuTklnJI
# 5aw7JFplQP+qebwcUz2iUSdjfpOnbXTQvspVIXzD4zklpMao7TPicwp1E5izanCi
# YZ+KaOhm+yM3EPvBEWMvI4v83MF9N7NHKWPxf6RPebth1VhVT2B0sibyP9Xe0nor
# GkSqgNw0FCBA24bD0sj0Cx6aGUcIdrK9VfZt1Mk2nFXNvOL1Xmygmo47WZgVsBCk
# 1gXT4ELGKEnaOvDbHnNdV9cUaSUyiS3wuuV+XIWt/NMhU5V+nOd2eqL4iexHBNKr
# NQ5L3/G10GHGvYnYUUd63TkI9EoGMH52SGeGcorfOaDEEo8rciWN+6rGNThX+9kD
# thNSTED2nzrbwE8ewpSRMq/NrNL7QEQ5Jof0ez9fYhCNXJOcAqXCqSR1lzY7YQ9i
# P/J+dxw0XIhsBsElH/uS0eXpXh/fIdOVJZ7Fl73K29VEYjXmoMwFx9qhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTI1MTUw
# OTE0WjA/BgkqhkiG9w0BCQQxMgQw0sz6MEMHQ0JaIq1jy0JZ7CJaETxEQNpee/Gn
# czW7ktfNYqFKooSz/EGthwr01MabMA0GCSqGSIb3DQEBAQUABIICAGnm76A9yIMp
# ulE1SvuNfe6W6qqOaVFjr+ilTrLQoFhBAMFzsmUAj9oqr71H18xqXb5LnKFevU1/
# YBEi5JA8lXfHccW097E9j1TANByxfmNl+uMrWicaalYWfnYjipLKj6yEIoTgo+3l
# a2vYvTveypWh2AQ+pabpLHX9bWoipIqPdodHz8R3P3yXUAm6kiIFfTx6MfOkxa2E
# kkDu/lxYUlSzPm9oBw2nLZaDqdaorrOGQd7PVZ9B2KCw1osB2X1V2k34sJbf6lQ1
# rqDokxej/XG9K9TQiITDE9sfrLQ13h5IFgIhfCpC80LCX5LkUJb5DdlAt3oV0A8C
# u6AdoPX4zhjl9z01RpoVH7IQ+gdnbW+5gO5x4jCQGGU2tR4oqMn/VmqAaS/rfes3
# fjIwMzKo843cTUiGZxxLuQ2+xmBrBdPWXSL0ye6qlt3a3f0N3oHVlvmHUxsenoPF
# LyD9amCoTCdl3qyF/lIjJdceNdZfGJ6kaJMt9jXKCgvO4lfMPDf8TFXJGcI5sK9J
# tgLfwZ/X9TpL3Gucsg0yekWSRP3xkuX2zYQWaBY78mIfQnCbbhedU+51lLwaiyo3
# 9QUs/zKSj9r1BB2RXxEwyXbCHME0TJ/cIRAjRaJrjIprKFrawBMTVBGU5cR90pVi
# TGgX9XU7Afx9Yo02tk9vSjwquEiCgebH
